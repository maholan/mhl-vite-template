...
interface PopoverProps extends PrimitivePopoverProps, RefAttributes<HTMLElement> {
  size: "sm" | "md" | "lg";
}
...
export const Popover = (props: PopoverProps): JSX.Element => {
  return (
    <PrimitivePopover
      ...
      className={(state) =>
        cn(
          "bg-primary ring-secondary-alt w-(--trigger-width) origin-(--trigger-anchor-point) overflow-x-hidden overflow-y-auto rounded-lg py-1 shadow-lg ring-1 outline-hidden will-change-transform",
